...
const HomePage = () => {
  ...
  const { data: divisionData, isLoading: divisionsLoading } =
      ...
      <section className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground mt-2">
            Handpicked regions for your next great escape
          </p>
        </div>
              ...
              >
                <div className="relative overflow-hidden rounded-2xl border bg-white p-6 transition-all hover:border-blue-500 hover:shadow-xl hover:shadow-blue-500/10">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Explore hidden gems in this region.
                  </p>
      ...
      <section className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {featuredTours.map((tour) => (
            <Card
              key={tour._id}
              className="group overflow-hidden rounded-3xl border-none shadow-md transition-all hover:shadow-2xl"
            >
              <div className="relative aspect-[16/10] overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <Badge className="bg-white/90 backdrop-blur-md text-black hover:bg-white">
                    {tour.division?.name}
                  </Badge>
                </div>
              ...
              <CardFooter className="p-6 pt-0">
                <Button
                  asChild
                  className="w-full rounded-xl bg-slate-950 py-6 transition-all hover:bg-blue-600"
                >
                  <Link to={`/tours/${tour.slug}`} onClick={scrollToTop}>
                    View Details
                  </Link>
                </Button>
              </CardFooter>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground">
              We've simplified the travel booking process so you can focus on
              the experience.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Browse our collection of hand-picked unique experiences.",
              },
              {
                icon: <ShieldCheck />,
                title: "Secure Booking",
                desc: "Confirm your spot with our encrypted and safe payment system.",
              },
              {
                icon: <Zap />,
                title: "Instant Access",
                desc: "Receive your digital itinerary and get ready to explore.",
              },
            ].map((step, i) => (
              <div
                key={i}
              ...
              >
                ...
                <p className="mt-3 text-muted-foreground max-w-[250px]">
                  {step.desc}
                </p>
              </div>
            ))}
        ...
        <div className="relative overflow-hidden rounded-[2.5rem] bg-blue-600 px-8 py-16 text-center text-white md:py-24">
          ...
          <div className="relative z-10 mx-auto max-w-2xl">
            <h2 className="text-4xl md:text-5xl font-extrabold leading-tight">
              Join 2,000+ travelers exploring the world
            </h2>
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <Button
                size="lg"
                className="rounded-full bg-white px-8 text-blue-600 hover:bg-blue-50"
              >
                Get Started Now
              </Button>
              <Button
